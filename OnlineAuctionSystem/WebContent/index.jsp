              ...
              <div class="collapse navbar-collapse">
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item">
                   ...
                   <li class="nav-item">
                    <a href="Billing.jsp" class="nav-link">Payment</a>
                  </li>
                </ul>
                ...
                <form action="myAccountEdit.jsp" method="post">
                	<button type="submit" class="btn btn-white btn-raised btn-fab btn-round" value="My Account">
                </form>
              </div>
            </div>
          </nav>
