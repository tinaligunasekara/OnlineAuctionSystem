  ...
  <div class="main main-raised" style="background-image: url('img/back3.jpeg');">
    ...
    <nav class="navbar navbar-expand-lg bg-primary" class="nav1">
          ...
          <body>
            ...
            <table claass="table" style="width:80%">
          <thead>
          ...
          PaymentService serv = new PaymentServiceImpl();
          
          ArrayList<Payment> list = serv.getAllPayments();
        ...
        <tr>
        	...
        	<form action="DeletePaymentServlet" method="post">
        	   <input type="hidden" name="deleteValue" value="<%=p.getPaymentId()%>">
        	   <input type="submit" name="btnDelete" value="Delete">
        	  </form>  
        	    
        	    <form action="GetCusIDServlet" method="post">
        	      <input type="hidden" name="updateValue" value="<%=p.getPaymentId()%>">
