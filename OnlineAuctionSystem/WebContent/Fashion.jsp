...
<div class="main main-raised" style="background-image: url('img/back1.jpeg');">
    ...
    <%
                    	ProductService fashion = new ProductServiceImpl();
                    
                    	ArrayList<Product> list = fashion.getAllFashion();
                    %>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card card-product">
                    <div class="card-header card-header-image">
                        ...
                        <a href="#pablo">
                         <img class="img" src = "img/<%=fas.getImage()%>">
                    ...
                    <div class="card-body">
                        ...
                        <h4 class="card-title">
                          ...
                          <input type="hidden" value="<%=fas.getProductID()%>" name="hiddenPId">
