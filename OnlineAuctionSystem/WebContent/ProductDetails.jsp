...
<%
ProductService detl = new ProductServiceImpl();
String s1 = (String)request.getAttribute("GetPid");
String pid=s1;


ArrayList<Product> list = detl.getAllDetails(pid);
...
%>
        ...
        <%
                 for(Product det : list){
        %>
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <div class="tab-content">
                        <div class="tab-pane active" id="product-page2">
                            <img src="img/<%=det.getImage()%>">
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    <h2 class="title"><%=det.getProductName() %></h2>
                    <div id="accordion" role="tablist">
                        ...
                        <table>
                            <tr>
                                <td><h5>Time</h5></td>
                                <td><a><%=det.getTime() %></a></td>
                            </tr>
                        <tr>
                            <td><h5>Brand</h5></td>
                            <td><a><%=det.getBrand() %></a></td>
                        </tr>
                        <tr>
                            <td><h5>Bid Rs.</h5>
                            <td><a><%=det.getStartingBid() %></a></td>
                        </tr>
                        </table>
                    </div>
                    ...
                    <form action="ProductDetail" method="post">
                    	<input id="pd" type="hidden" class="productD" name="productD" value="<%=det.getProductID()%>">
                        <button class="btn btn-primary btn-round">Place Bid</button>
