...
<div class="main main-raised" style="background-image: url('img/back1.jpeg');">
    ...
    <%
                    	ProductService comele = new ProductServiceImpl();
                    
                    	ArrayList<Product> list = comele.getAllComputers();
                    %>

    <!---computers & electronics------- -->
    <div class="container" >
        <div class="text-center">
            <h1 class="title">COMPUTERS & ELECTRONICS</h1>
        </div>

        <div class="row">
        <%
                        	for(Product com : list){
                        %>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card card-product">
                    <div class="card-header card-header-image">
                        ...
                        <a href="#pablo">
                         <img class="img" src = "img/<%=com.getImage()%>">
                    ...
                    <div class="card-body">
                        ...
                        <h4 class="card-title">
                          ...
                          <input type="hidden" value="<%=com.getProductID()%>" name="hiddenPId">
