...
<div class="main main-raised" style="background-image: url('img/back1.jpeg');">
    ...
    <%
                    	ProductService sport = new ProductServiceImpl();
                    
                    	ArrayList<Product> list = sport.getAllSport();
                    %>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card card-product">
                    <div class="card-header card-header-image">
                        ...
                        <a href="#pablo">
                         <img class="img" src = "img/<%=spo.getImage()%>">
                    ...
                    <div class="card-body">
                        ...
                        <h4 class="card-title">
                          ...
                          <input type="hidden" value="<%=spo.getProductID()%>" name="hiddenPId">
