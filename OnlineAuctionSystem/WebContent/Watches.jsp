...
<div class="main main-raised" style="background-image: url('img/back10.jpg');">
    ...
    <%
                    	ProductService watc = new ProductServiceImpl();
                    
                    	ArrayList<Product> list = watc.getAllWatches();
                    %>

    <!---Watches------- -->
    <div class="container" >
        <div class="text-center">
            <h1 class="title"> WATCHES</h1>
        </div>

        <div class="row">
        <%
                        	for(Product wat : list){
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card card-product">
                    <div class="card-header card-header-image">
                        ...
                        <a href="#pablo">
                         <img class="img" src = "img/<%=wat.getImage()%>">
                    ...
                    <div class="card-body">
                        ...
                        <h4 class="card-title">
                          ...
                          <input type="hidden" value="<%=wat.getProductID()%>" name="hiddenPId">
