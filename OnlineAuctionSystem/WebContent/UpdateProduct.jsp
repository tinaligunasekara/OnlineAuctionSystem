...
<body>
  ...
  <div class="main main-raised" style="background-image: url('img/back3.jpeg');">
    <nav class="navbar navbar-expand-lg bg-primary" class="nav1">
     ...
     <form class="form" action="UpdateProductServlet" method="post" >
          ...
          <div class="form-group col-md-2 ml-auto">
              <label style="color: black;">Starting Bid</label>
		...
		<%
			String editPid =(String)request.getAttribute("EditPid");
		%>	
			<input type="hidden" value="<%=editPid%>" name="editPid">
          <button type="submit" class="btn btn-primary al" id="updateProduct">Save Changes</button>
      </form>
  ...
  $(document).ready(function(){
	    $("#fuel").change(function(){
	        ...
	        $.ajax(
			        {
			            type: "post",
			            url: "http://localhost:8081/VehicleServicesAndFuelManagementSystem/UpdateProductServlet",
