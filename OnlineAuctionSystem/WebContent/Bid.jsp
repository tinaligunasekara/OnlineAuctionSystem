...
<div class="main main-raised" style="background-image: url('img/back3.jpeg');">
    ...
    String s1 = (String)request.getAttribute("pdd");
   
    int productID =Integer.parseInt(s1); 
    //int productID = 2;
    
    //String s4 =(String)session.getAttribute("UserId");
    ...
    <div class="main main-raised">
        <div class="container">
            <div class="card card-plain">
                <div class="card-body">
                    <h3 class="card-title">Bid Amount</h3>
                    ...
                    <form action="AddBidServlet" method="post">
                    	<input type="hidden" class="bidform" name="userId" value="<%=userID%>">
                   		 <input type="hidden" class="bidform" name="productIdName" value="<%=productID%>">
                        <input type="text" class="bidform" name="bidform" id="bidPrice" required>
                    ...
                    <% 
                    	...
                    	int bidd=service.searchBidId(productID, userID);
                    
                    %>
                   
                    <input id="bid" type="hidden" class="bidform" name="bid" value="<%=bidd%>">
                    <button type="submit" class="btn btn-primary" id="btnBid">Update</button>
                    
                    <form action="HighestBid.jsp" method="post">
                    	<button type="submit" class="btn btn-primary" id="btnBid">Max Bid</button>
                    </form>
	  ...
	  $(document).ready(function(){
		    $("#btnBid").click(function(){
		        ...
		        $.ajax(
				        {
				            type: "post",
				            url: "http://localhost:8085/OnlineAuctionSystem/UpdateBidServlet",
