...
<div class="main main-raised" style="background-image: url('img/back1.jpeg');">
    ...
    <%
                    	ProductService sung = new ProductServiceImpl();
                    
                    	ArrayList<Product> list = sung.getAllSunglasses();
                    %>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card card-product">
                    <div class="card-header card-header-image">
                        ...
                        <a href="#pablo">
                         <img class="img" src = "img/<%=sun.getImage()%>">
                    ...
                    <div class="card-body">
                        ...
                        <h4 class="card-title">
                         ...
                         <form action="productbtnServlet" method="post" >
                          <input type="hidden" value="<%=sun.getProductID()%>" name="hiddenPId">
