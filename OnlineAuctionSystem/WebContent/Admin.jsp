    ...
    <nav class="navbar navbar-expand-lg bg-primary" class="nav1">
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav">
                	<li class="nav-item">
                        <a href="#pablo" class="nav-link">Dashboard</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="row">
        <div class="col-md-4">
            <ul class="nav nav-pills nav-pills-primary flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="ProductManagement.jsp" data-toggle="ProductManagement.jsps">PRODUCT</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="BidTable.jsp" data-toggle="BidTable.jsp">BID</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="UserManagement.jsp" data-toggle="UserManagement.jsp">USERS</a>
                </li>
                <li class="nav-item" >
                    <a class="nav-link" href="PayTable.jsp" data-toggle="PayTable.jsp" >PAYMENT</a>
                </li>
            </ul>
        </div>
